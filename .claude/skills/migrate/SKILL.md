...
allowed-tools: Read Write Edit Glob Bash(test:*) Bash(ls:*) Bash(mkdir:*) Bash(cp:*) Bash(mv:*) Bash(date:*)
...
- Gemini `{{args}}` is lossy vs Claude's `$1..$9` / `$NAMED`. List affected commands.
